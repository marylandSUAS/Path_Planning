...
#define RESOLUTION_X 30 //keep square for 2d interpolation
#define RESOLUTION_Y 30 //keep square for 2d interpolation
#define RESOLUTION_VERTICAL 15 //keep unit for 2d interpolation
#define CSP 0
#define UPDATE 1
#define DISP 2
#define PREDSUCC 3
...
// 3 - calculate location increment
	...
	double min_dimension_size = 100; // [m]
	double x_size = x_loc_increment*RESOLUTION_X;
	double y_size = y_loc_increment*RESOLUTION_Y;
	double z_size = z_loc_increment*RESOLUTION_VERTICAL;

	x_buffer = x_size > 100 ? buffer_percent*x_size/2 : min_dimension_size/2;
	y_buffer = y_size > 100 ? buffer_percent*y_size/2 : min_dimension_size/2;
	z_buffer = z_size > 100 ? buffer_percent*z_size/2 : min_dimension_size/2;
...
int main(){
	...
	x_loc_increment = goal_location[0]-start_location[0]/RESOLUTION_X
	y_loc_increment = goal_location[1]-start_location[1]/RESOLUTION_Y
